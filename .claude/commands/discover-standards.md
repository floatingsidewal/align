...
4. Create or update the file in `align/standards/[folder]/`
...
1. Scan `align/standards/` for all `.md` files
...
3. Update `align/standards/index.yml`:
...
All standards: `align/standards/[folder]/[standard].md`
Index file: `align/standards/index.yml`
